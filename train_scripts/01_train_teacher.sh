...
#SBATCH --job-name=sf-jhu-dvrk-cp2.5
#SBATCH --nodes=8
...
#SBATCH --gres=gpu:8
#SBATCH --time=4:00:00
#SBATCH --output=logs/jhu-dvrk-cp2.5_%A_%a.out
#SBATCH --error=logs/jhu-dvrk-cp2.5_%A_%a.out
...
REPO_DEST="/lustre/fsw/portfolios/healthcareeng/users/lzbinden/imaginaire/output/repo/sf-hamlyn/run_${TIMESTAMP}_${SLURM_JOB_NAME:-unknown}"
...
TIMESTAMP.....: ${TIMESTAMP}
REPO_ROOT.....: ${REPO_ROOT}
LOG_FILE......: ${REPO_ROOT}/logs/jhu-dvrk-cp2.5_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out
EOF
